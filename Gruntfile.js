...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            bootstrap: {
                src: ['js/transition.js', 'js/alert.js', 'js/button.js', 'js/carousel.js', 'js/collapse.js', 'js/dropdown.js', 'js/modal.js', 'js/tooltip.js', 'js/popover.js', 'js/scrollspy.js', 'js/tab.js', 'js/affix.js', 'js/sdtoggle.js'],
